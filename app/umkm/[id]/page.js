                ...
                <div className="pt-2 flex flex-col gap-3">
                  {umkm.instagram && (
                    <a href={`https://instagram.com/${umkm.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-2.5 bg-surface hover:bg-white text-text-muted hover:text-[#E1306C] rounded-xl border border-border hover:border-[#E1306C]/30 shadow-sm hover:shadow-md transition-all duration-300 group">
                      ...
                      <span className="font-medium text-sm text-text-primary group-hover:text-[#E1306C] transition-colors">{umkm.instagram}</span>
                    </a>
                  )}
                  {umkm.tiktok && (
                    <a href={`https://tiktok.com/@${umkm.tiktok.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-2.5 bg-surface hover:bg-white text-text-muted hover:text-black rounded-xl border border-border hover:border-black/30 shadow-sm hover:shadow-md transition-all duration-300 group">
                  ...
                  {umkm.facebook && (
                    <a href={`https://facebook.com/search/top?q=${encodeURIComponent(umkm.facebook)}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-2.5 bg-surface hover:bg-white text-text-muted hover:text-[#1877F2] rounded-xl border border-border hover:border-[#1877F2]/30 shadow-sm hover:shadow-md transition-all duration-300 group">
                      ...
                      <span className="font-medium text-sm text-text-primary group-hover:text-[#1877F2] transition-colors">{umkm.facebook}</span>
                    </a>
                  )}
                </div>
              </div>
